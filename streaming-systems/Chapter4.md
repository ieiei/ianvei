...
![](/Users/Laobe/Documents/Streaming-Systems/images/stsy_0401.mp4)

<center><i>图 4-1。在处理时间、保持值和事件时间常数中改变输入观察顺序
...
![](/Users/Laobe/Documents/Streaming-Systems/images/stsy_0402.mp4)

<center><i>图4-2 相同输入的两个不同处理时间顺序上的事件时间窗口
...
![](/Users/Laobe/Documents/Streaming-Systems/images/stsy_0403.mp4)

<center><i>图 4-3。通过触发器的处理时间“窗口化”，相同输入的两个不同处理时间排序
...
![](/Users/Laobe/Documents/Streaming-Systems/images/stsy_0404.mp4)

<center><i>图 4-4。通过使用入口时间的处理时间窗口，在相同输入的两个不同处理时间排序上
...
![](/Users/Laobe/Documents/Streaming-Systems/images/stsy_0405.png)

<center><i>图 4-5。 未合并的原始会话窗口，以及由此产生的合并会话
...
![](/Users/Laobe/Documents/Streaming-Systems/images/stsy_0406.png)

<center><i>图 4-6。我们要计算的会话
...
![](/Users/Laobe/Documents/Streaming-Systems/images/stsy_0407.mp4)

<center><i>图 4-7。流媒体引擎上的会话窗口和撤回的早期和晚期触发
...
![](/Users/Laobe/Documents/Streaming-Systems/images/stsy_0408.mp4)

<center><i>图 4-8。对齐的固定窗口
...
![](/Users/Laobe/Documents/Streaming-Systems/images/stsy_0409.mp4)

<center><i>图 4-9。未对齐的固定窗口
...
![](/Users/Laobe/Documents/Streaming-Systems/images/stsy_0410.mp4)

<center><i>图 4-10。 每键自定义大小的固定窗口
...
![](/Users/Laobe/Documents/Streaming-Systems/images/stsy_0411.mp4)

<center><i>图 4-11。 每键自定义大小的固定窗口
